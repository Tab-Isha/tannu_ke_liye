        ...
        <div class="container-fluid"> 
            ...
            <ul class="nav navbar-nav navbar-center"> 
              ...
              <li class="nav-item dropdown"> 
                ...
                <div class="dropdown-menu"> 
                    <a class="dropdown-item" href="managebooks/add_book.php">Add New Book</a> 
                    <div class="dropdown-divider"></div> 
                    <a class="dropdown-item" href="managebooks/manage_book.php">Manage Books</a> 
                </div> 
              </li> 
              <li class="nav-item dropdown"> 
                <a class="nav-link dropdown-toggle" data-toggle="dropdown">Category </a> 
                <div class="dropdown-menu"> 
                    <a class="dropdown-item" href="book_category_module/add_cat.php">Add New Category</a> 
                    <div class="dropdown-divider"></div> 
                    <a class="dropdown-item" href="book_category_module/manage_cat.php">Manage Category</a> 
                </div> 
              </li> 
              <li class="nav-item dropdown"> 
